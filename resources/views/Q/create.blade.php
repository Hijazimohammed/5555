          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h5 class="well"> * تحريري - اضافة سؤال جديد </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                </button>
              </div>
              <div class="modal-body">
                <form method="POST" action="{{route('Qasts.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                          ...
                          <input name="qust" type="text" id="MainContent_txtFullName" class="form-control requiredTextField">
                        </div>
                        <div class="col-sm-4 form-group">
                      ...
                      <div class="row">
                        <div class="col-sm-4 form-group">
                          ...
                          <input name="ans1" type="text" id="MainContent_txt_LicenceNo" class="form-control requiredTextField">
                        </div>
                        <div class="col-sm-4 form-group">
  
                          <label> الخيار رقم 3: <span class="red-dot">*</span></label>
                          <input name="ans3" type="text" id="MainContent_txt_LicenceNo" class="form-control requiredTextField">
                      ...
                      <div class="row">
                        <div class="col-sm-4 form-group mb-3">
                          ...
                          <input name="ans2" type="text" id="MainContent_txt_LicenceNo" class="form-control requiredTextField">
                        </div>
                        <div class="col-sm-4 form-group">
  
                          <label> الخيار رقم 4: <span class="red-dot">*</span></label>
                          <input name="ans4" type="text" id="MainContent_txt_LicenceNo" class="form-control requiredTextField">
                        </div>
                      </div>
                        ...
                        <div class="col-sm-4 form-group">
                          ...
                          <div class="input-group">
                            <label class="input-group-btn ">
                              <span class="btn btn-primary "><span class="fa fa-folder-open"></span>&nbsp;اختر ملف...
                                <input type="file" name="signal" id="MainContent_fu_IDNoImg" class=" hidden" accept=".png, .PNG, .jpg, .JPG, .jpeg, .JPEG">
                              </span>
                            </label>
                          </div>
                        </div>
        ...
        <tbody>
          @foreach($qasts as $qast)
            ...
            <th scope="row">{{$qast->id}} </th>
              ...
              <td><img src="{{asset('storage/signals/'. $qast->signal)}}" height="50" width="50"> </td>
